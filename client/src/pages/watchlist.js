...
import User from "../../../server/src/models/authSchema.js";
...
//       if (session) {
//         const result = await User.find(session.user.name); // Use the findOneByUsername method
//         setUser(result);
//       }
//     };
...
//           <h1>Welcome {session.user.name}!</h1>
//           <p>Add a coin to your record!</p>
//           {user && <MyComponent user={user} />} {/* Pass the user data as a prop */}
//         </>
//       ) : (
//         <h1>Sign up or log in to get access!</h1>
//       )}
